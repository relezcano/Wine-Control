    ...
    if($despacho == 1)
      {
          ...
          $idRecive = ($_POST['idRecive']);

          $sql = "INSERT INTO dispatch (transport, dateDis, dateAr, send, recive, guide, amountPack, origin, destination, commission, obs, idEmploy, idRecive)
          VALUES ('$form_tran', '$form_ds', '$form_dl', '$form_send', '$form_recive', '$form_guide', '$form_pack', '$form_origin', '$form_dest', '$form_comm', '$form_obs', '$idEmploy','$idRecive')";//Se insertan los datos a la base de datos.
